		...
		<nav id="sidebar-wrapper">
			...
			<c:choose>
		        <c:when test="${sessionScope.user != null}">
		            <li class="sidebar-brand"><a href="/Logout">로그아웃</a>
		            <li class="sidebar-brand">로그인한 유저: ${sessionScope.user.id}</li>
		        </c:when>
		        <c:otherwise>
		            <li class="sidebar-brand"><a href="/Login">로그인 ></a>
		        </c:otherwise>
	        </c:choose>
		...
		<nav class="navbar bg-light">
		  <div class="container-fluid">
		    <a class="navbar-brand" href="/">
		      <img src="/static/img/head.png" alt="Logo" width="30" height="24" class="d-inline-block align-text-top">
		      Floritz
		    </a>
		  </div>
		</nav>
